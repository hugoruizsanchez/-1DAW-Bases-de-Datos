...
DROP DATABASE IF EXISTS db_vistas;
CREATE DATABASE bd_vistas;
USE bd_vistas;
...
/* 1. Crear una vista llamada EMPLEADOS_TODOS_NULL que almacene los campos EMP_NO,
APELLIDO y OFICIO de la tabla EMPLEADOS y los campos DNOMBRE y LOCALIDAD de la
tabla DEPARTAMENTOS. Incluyendo los departamentos que no tienen ningún
empleado. Ordenada alfabéticamente por APELLIDO
Mostrar el resultado de la ejecución de esta sentencia SELECT * FROM
EMPLEADOS_TODOS_NULL*/



CREATE VIEW EMPLEADOS_TODOS_NULL
AS SELECT EMP_NO, APELLIDO, OFICIO, DNOMBRE, LOCALIDAD 
FROM EMPLEADOS 
RIGHT JOIN DEPARTAMENTOS ON EMPLEADOS.DEP_NO = DEPARTAMENTOS.DEP_NO
ORDER BY APELLIDO; 

SELECT * FROM EMPLEADOS_TODOS_NULLa;

/*2 Borrar de la tabla EMPLEADOS todos aquellos empleados cuyo oficio sea vendedor,
empleado o analista. Mostar el resultado de la ejecución de esta sentencia SELECT *
FROM EMPLEADOS_TODOS. ¿Coincide el resultado de este ejercicio con el resultado del
ejercicio 4? Si no coincide, explicar el motivo.
Lanzar el script “cargartablas_Ejercicios_Vistas.sql” desde mysql*/

DELETE FROM EMPLEADOS WHERE OFICIO = "VENDEDOR" OR OFICIO = "EMPLEADO" OR OFICIO ="ANALISTA";

/*3. Crear una vista llamada EMPLEADOS_NO_DEP_20_40 que almacene todos los campos
de la tabla EMPLEADOS y los campos DNOMBRE y LOCALIDAD de la tabla
DEPARTAMENTOS, únicamente de aquellos empleados que no pertenezcan al
departamento 20 ni 40.
Mostrar el resultado de la ejecución de esta sentencia SELECT * FROM
EMPLEADOS_NO_DEP_20_40 */

CREATE VIEW EMPLEADOS_NO_DEP_20_40 
AS SELECT EMP_NO, APELLIDO, OFICIO, DIRECTOR, FECHA_ALTA, SALARIO, COMISION, DEP_NO, DNOMBRE, LOCALIDAD
FROM EMPLEADOS 
JOIN DEPARTAMENTOS  ON EMPLEADOS.DEP_NO = DEPARTAMENTOS.DEP_NO AND
EMPLEADOS.DEP_NO != 20 AND EMPLEADOS.DEP_NO != 40;

/*4. Modificar a través de la vista EMPLEADOS_NO_DEP_20_40 el sueldo del empleado de
número 7521 de forma que pase a cobrar 1500 € y el departamento al que pertenece
(CONTABILIDAD) cambie de nombre y pase a llamarse “VENTAS MENOR”.*/



/* 5. Insertar a través de la vista EMPLEADOS_NO_DEP_20_40 un nuevo empleado con
número de empleado 8000, apellido SANCHEZ, oficio OPERARIO, DIRECTOR 7839,
FECHA DE ALTA 1981-12-08, SALARIO 1100, NUMERO DE DEPARTAMENTO 50. Debe
insertar también los datos del nuevo departamento NUMERO DE DEPARTAMENTO 50,
NOMBRE DEPARTAMENTO “SERVICIOS”, LOCALIDAD “MADRID”
*/
